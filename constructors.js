...
User.prototype.removeSavedPost = function(num){
  let deleteMe = this.savedPosts.findIndex(e => e.id === num)
  this.savedPosts.splice(deleteMe, 1)
}
...
User.prototype.changePostRating = function(num, newRating){
  let changeMe = this.savedPosts.find(e => e.id === num)
  changeMe.rating = newRating
}
